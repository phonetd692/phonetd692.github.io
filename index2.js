...
class TrysteroProvider extends ObservableV2 {
  ...
  constructor (
    ...
    super();
    console.log('TrysteroProvider constructor', { roomName, doc, trysteroRoom, password, awareness, maxConns, filterBcConns });
    this.doc = doc;
...
// console.log({ drawingDemo })

// Dynamically import the drawing component
import('./drawing.js').then(() => {
  console.log('drawing.js loaded');
  // After loading, you can initialize or manipulate the drawingDemo element if needed
  if (drawingDemo) {
    console.log('Found drawing demo element:', drawingDemo);
    // Any further initialization logic for the drawingDemo
  }
}).catch(error => {
  console.error('Error loading drawing.js:', error);
});
...
// @ts-ignore
window.example = { provider, doc: doc$1, yarray };

export { ELEMENT_NODE as E, YMap as Y, addEventListener$1 as a, assign as b, equalityFlat as c, from as d, emitCustomEvent as e, fromCamelCase as f, querySelectorAll as g, checkNodeType as h, isNaN as i, parseFragment as j, keys as k, replaceWith as l, appendChild as m, parse as n, YArray as o, parseElement as p, querySelector as q, remove as r, stringify as s, drawingContent as t };
